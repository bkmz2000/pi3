    ...
    entries: [
      ...
      },
      {
        ...
        params: [
          ...
          { name: "update()", type: "—", en: "Override in subclass to run logic each frame.", ru: "Переопределите в подклассе для запуска логики каждый кадр." },
  ...
  // ─── Utilities ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "Return a random color name from the Colors palette.",
        ru: "Возвращает случайное название цвета из палитры Colors.",
        returns: { type: "str", en: "A color name string.", ru: "Строка с названием цвета." },
      },
      {
        id: "assets_sprites",
        name: "assets.sprites",
