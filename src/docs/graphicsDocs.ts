...
export const DOCS: DocCategory[] = [
  ...
  // ─── Drawing ───────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "circle",
        name: "circle",
        signature: "circle(x, y, radius) or circle(p, radius)",
        en: "Draw a filled circle centered at (x, y) with the given radius. Center can be a point (tuple or Vector2) instead of x, y.",
        ru: "Рисует закрашенный круг с центром в точке (x, y) и заданным радиусом. Центр можно передать точкой (кортеж или Vector2) вместо x, y.",
        example: 'fill("red")\ncircle(100, 100, 30)\ncircle((100, 100), 30)  # same, via a point',
        params: [
          { name: "x", type: "number", optional: true, en: "Center X position (2-number form).", ru: "Координата X центра (форма с 2 числами)." },
          { name: "y", type: "number", optional: true, en: "Center Y position (2-number form).", ru: "Координата Y центра (форма с 2 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Center point (point form).", ru: "Точка центра (форма с точкой)." },
      ...
      },
      {
        id: "rect",
        name: "rect",
        signature: "rect(x, y, w, h) or rect(p, w, h)",
        en: "Draw a filled rectangle. The top-left corner is at (x, y), or at a point p instead.",
        ru: "Рисует закрашенный прямоугольник. Левый верхний угол находится в точке (x, y), или в точке p.",
        example: "rect(50, 50, 120, 80)\nrect((50, 50), 120, 80)  # same, via a point",
        params: [
          { name: "x", type: "number", optional: true, en: "Left edge X (4-number form).", ru: "Координата X левого края (форма с 4 числами)." },
          { name: "y", type: "number", optional: true, en: "Top edge Y (4-number form).", ru: "Координата Y верхнего края (форма с 4 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Top-left point (point form).", ru: "Точка левого верхнего угла (форма с точкой)." },
      ...
      },
      {
        id: "ellipse",
        name: "ellipse",
        signature: "ellipse(x, y, w, h) or ellipse(p, w, h)",
        en: "Draw a filled ellipse centered at (x, y), or at a point p instead. Omit h to draw a circle.",
        ru: "Рисует закрашенный эллипс с центром в точке (x, y), или в точке p. Опустите h, чтобы нарисовать круг.",
        example: "ellipse(100, 100, 120, 60)\nellipse((100, 100), 120, 60)  # same, via a point",
        params: [
          { name: "x", type: "number", optional: true, en: "Center X (4-number form).", ru: "Координата X центра (форма с 4 числами)." },
          { name: "y", type: "number", optional: true, en: "Center Y (4-number form).", ru: "Координата Y центра (форма с 4 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Center point (point form).", ru: "Точка центра (форма с точкой)." },
      ...
      },
      {
        id: "line",
        name: "line",
        signature: "line(x1, y1, x2, y2) or line(p1, p2)",
        en: "Draw a line between two points. Pass four numbers, or two points (tuples or Vector2).",
        ru: "Рисует линию между двумя точками. Передайте четыре числа или две точки (кортежи или Vector2).",
        example: 'stroke("black")\nline(20, 20, 180, 120)\nline((20, 20), (180, 120))  # same, via points',
        params: [
          { name: "x1", type: "number", optional: true, en: "Start X (4-number form).", ru: "Начальная координата X (форма с 4 числами)." },
          { name: "y1", type: "number", optional: true, en: "Start Y (4-number form).", ru: "Начальная координата Y (форма с 4 числами)." },
          { name: "x2", type: "number", optional: true, en: "End X (4-number form).", ru: "Конечная координата X (форма с 4 числами)." },
          { name: "y2", type: "number", optional: true, en: "End Y (4-number form).", ru: "Конечная координата Y (форма с 4 числами)." },
          { name: "p1", type: "(x, y) | Vector2", optional: true, en: "Start point (2-point form).", ru: "Начальная точка (форма с 2 точками)." },
          { name: "p2", type: "(x, y) | Vector2", optional: true, en: "End point (2-point form).", ru: "Конечная точка (форма с 2 точками)." },
        ],
      },
      {
        id: "polyline",
      ...
      },
      {
        id: "point",
        name: "point",
        signature: "point(x, y) or point(p)",
        en: "Draw a single dot at position (x, y), or at a point p (tuple or Vector2).",
        ru: "Рисует одну точку в позиции (x, y), или в точке p (кортеж или Vector2).",
        example: "stroke_width(4)\npoint(150, 100)\npoint((150, 100))  # same, via a point",
        params: [
          { name: "x", type: "number", optional: true, en: "X position (2-number form).", ru: "Координата X (форма с 2 числами)." },
          { name: "y", type: "number", optional: true, en: "Y position (2-number form).", ru: "Координата Y (форма с 2 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Position (point form).", ru: "Позиция (форма с точкой)." },
        ],
      },
      {
        id: "text",
  ...
  // ─── Color ─────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "fill_color",
        name: "fill",
        signature: 'fill(color)  /  fill(r, g, b)  /  fill(None)  /  fill()',
        en: 'Set the fill color. Accepts a color name string ("red"), a Colors.* tuple, three RGB numbers (0–255), a single gray value, or None to disable fill (same as no_fill()). Unknown color names raise a friendly badColor error.',
        ru: 'Устанавливает цвет заливки. Принимает строку с названием цвета ("red"), кортеж Colors.*, три числа RGB (0–255), одно число для серого или None для отключения заливки (то же, что no_fill()). Неизвестные имена цветов вызывают дружелюбную ошибку badColor.',
        example: 'fill("red")\ncircle(100, 100, 30)',
        advanced: {
          en: "Fill is a *state machine*: once set, every subsequent shape uses this color until you change it. The state survives across `main()` calls within a frame but resets to its initial value at the start of every frame, so you must re-call `fill` each frame (or wrap it in `push`/`pop` if you only want the change to be local). `fill(None)` and the zero-arg `fill()` are both identical to `no_fill()` — use whichever reads more naturally. Color names are validated strictly: a typo (e.g. `fill(\"reed\")`) raises a friendly badColor error instead of silently drawing white, and hex strings like `fill(\"#ff0000\")` work.",
          ru: "Заливка — это *состояние*: задал — все последующие фигуры используют этот цвет, пока не изменишь. Состояние сохраняется между вызовами в пределах одного кадра, но сбрасывается к исходному в начале каждого кадра — поэтому `fill` нужно вызывать каждый кадр (либо заворачивай в `push`/`pop`, если изменение должно быть локальным). `fill(None)` и вызов `fill()` без аргументов — оба идентичны `no_fill()`: используй ту запись, что лучше читается. Имена цветов проверяются строго: опечатка (например, `fill(\"reed\")`) вызывает дружелюбную ошибку badColor вместо молчаливого белого цвета, а hex-строки вида `fill(\"#ff0000\")` работают.",
        },
        params: [
  ...
  // ─── Sprites (pixel data) ──────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      {
        id: "sprite_from_ascii",
        name: "Sprite.from_ascii",
        signature: 'Sprite.from_ascii(art, bg=" ", **color_chars)',
        en: "Build a Sprite from an ASCII-art string. Each keyword name is a color; its value is the character marking that color in `art`. Characters that map to no color, including bg, are transparent. Sized automatically to the art's rows and longest row.",
        ru: "Создаёт Sprite из ASCII-арта. Имя каждого именованного аргумента — цвет; значение — символ, которым этот цвет отмечен в `art`. Символы без сопоставления, включая bg, становятся прозрачными. Размер подбирается автоматически по числу строк и самой длинной строке.",
        example: 'hero = Sprite.from_ascii("""\n    .rr.\n    rrrr\n    .rr.\n""", red="r")',
        advanced: {
          en: "A typo'd color name (a kwarg that isn't a recognized palette color) raises the same friendly badColor error as fill()/stroke() — the kwarg name is validated the same way. The `bg` character is always transparent even if it also appears as a color's marker character elsewhere in `color_chars` (bg wins).",
          ru: "Опечатка в имени цвета (аргумент, не входящий в палитру) кидает ту же дружелюбную ошибку badColor, что и fill()/stroke() — имя аргумента проверяется так же. Символ `bg` всегда прозрачен, даже если он же случайно назначен символом другого цвета в `color_chars` (bg побеждает).",
        },
        params: [
          { name: "art", type: "str", en: "Multi-line ASCII art. Common leading whitespace and leading/trailing blank lines are stripped automatically.", ru: "Многострочный ASCII-арт. Общие отступы слева и пустые строки по краям убираются автоматически." },
          { name: "bg", type: "str", optional: true, default: '" "', en: "Character that always maps to transparent.", ru: "Символ, всегда означающий прозрачность." },
          { name: "color_chars", type: "kwargs", en: "color_name=\"char\" pairs, e.g. red=\"r\", blue=\"b\".", ru: "Пары color_name=\"char\", например red=\"r\", blue=\"b\"." },
        ],
        returns: { type: "Sprite", en: "A new Sprite painted from the art.", ru: "Новый Sprite, раскрашенный по арту." },
      },
      {
        id: "get_pixel",
        name: "get_pixel",
      ...
      },
      {
        id: "darken",
        name: "sprite.darken",
        signature: "sprite.darken(x, y, steps=1)",
      ...
      },
      {
        id: "lighten",
        name: "sprite.lighten",
        signature: "sprite.lighten(x, y, steps=1)",
        ...
        example: 'for x in range(hero.width):\n    hero.lighten(x, 0, 1)  # top-edge highlight',
        params: [
          { name: "x", type: "number", en: "Column.", ru: "Колонка." },
          { name: "y", type: "number", en: "Row.", ru: "Строка." },
      ...
      {
        id: "saturate",
        name: "sprite.saturate",
        signature: "sprite.saturate(x, y, steps=1)",
      ...
      },
      {
        ...
        signature: "sprite.desaturate(x, y, steps=1)",
        ...
        example: 'banner.desaturate(4, 4, 2)',
        params: [
          { name: "x", type: "number", en: "Column.", ru: "Колонка." },
          { name: "y", type: "number", en: "Row.", ru: "Строка." },
      ...
      {
        id: "sprite_get_set",
        name: "sprite.get / sprite.set",
        signature: "sprite.get(x, y)  /  sprite.set(x, y, color)",
        en: "Method-shaped equivalents of get_pixel(sprite, x, y) and set_pixel(sprite, x, y, color) — same behavior, called on the sprite directly.",
        ru: "Методные эквиваленты get_pixel(sprite, x, y) и set_pixel(sprite, x, y, color) — то же поведение, вызывается прямо на спрайте.",
        example: "color = hero.get(3, 3)\nhero.set(3, 3, Colors.red)",
        params: [
          { name: "x", type: "number", en: "Column.", ru: "Колонка." },
          { name: "y", type: "number", en: "Row.", ru: "Строка." },
          { name: "color", type: "color | None", en: "(set only) Fill color, or None to erase.", ru: "(только set) Цвет заливки или None для стирания." },
        ],
      },
      {
        id: "sprite_context_manager",
        name: "with sprite.image as img:",
        signature: "with sprite: ...",
        en: "A Sprite is usable as a context manager purely for scoping pixel edits visually — it does not batch or defer anything: every draw already re-ships the full pixel buffer regardless. __enter__ returns the sprite itself.",
        ru: "Sprite можно использовать как контекстный менеджер — чисто визуально группирует правки пикселей, ничего не откладывает и не батчит: каждая отрисовка и так пересылает весь буфер пикселей целиком. __enter__ возвращает сам спрайт.",
        example: "with hero.image as img:\n    img.set(0, 0, Colors.red)\n    img.set(1, 0, Colors.red)",
      },
      {
        id: "pixel_view",
        name: "PixelView",
  ...
  // ─── Transforms ────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "translate",
        name: "translate",
        signature: "translate(x, y) or translate(p)",
        en: "Move the drawing origin by (x, y), or by a point/vector p. Shapes drawn after this will be shifted.",
        ru: "Перемещает начало системы координат на (x, y), или на точку/вектор p. Фигуры, нарисованные после, будут смещены.",
        example: "translate(100, 50)\ncircle(0, 0, 20)  # actually drawn at (100, 50)\ntranslate((100, 50))  # same, via a point",
        advanced: {
        ...
        params: [
          { name: "x", type: "number", optional: true, en: "Horizontal shift (2-number form).", ru: "Горизонтальное смещение (форма с 2 числами)." },
          { name: "y", type: "number", optional: true, en: "Vertical shift (2-number form).", ru: "Вертикальное смещение (форма с 2 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Offset (point form).", ru: "Смещение (форма с точкой)." },
        ],
      },
      {
        id: "rotate",
      ...
      },
      {
        id: "translated",
        name: "translated",
        signature: "with translated(dx, dy): ...  or  with translated(p): ...",
        en: "Context-manager shorthand for push(); translate(dx, dy); ...; pop() — the block is automatically wrapped, so you can't forget the matching pop(). Also accepts a single point/vector p instead of dx, dy. Composes with rotated(), scaled(), and plain push()/translate()/rotate().",
        ru: "Сокращение-контекстный менеджер для push(); translate(dx, dy); ...; pop() — блок оборачивается автоматически, забыть парный pop() невозможно. Также принимает точку/вектор p вместо dx, dy. Комбинируется с rotated(), scaled() и обычными push()/translate()/rotate().",
        example: "with translated(100, 50):\n    circle(0, 0, 10)   # drawn at (100, 50)\ncircle(0, 0, 10)       # back at (0, 0)",
        params: [
          { name: "dx", type: "number", optional: true, en: "Horizontal offset (2-number form).", ru: "Смещение по горизонтали (форма с 2 числами)." },
          { name: "dy", type: "number", optional: true, en: "Vertical offset (2-number form).", ru: "Смещение по вертикали (форма с 2 числами)." },
          { name: "p", type: "(x, y) | Vector2", optional: true, en: "Offset (point form).", ru: "Смещение (форма с точкой)." },
        ],
      },
      {
        id: "rotated",
        name: "rotated",
        signature: "with rotated(angle): ...",
        en: "Context-manager shorthand for push(); rotate(angle); ...; pop().",
        ru: "Сокращение-контекстный менеджер для push(); rotate(angle); ...; pop().",
        example: "with translated(100, 100):\n    with rotated(45):\n        rect(-20, -20, 40, 40)  # rotated 45° around (100, 100)",
        params: [
          { name: "angle", type: "number", en: "Rotation angle in degrees.", ru: "Угол поворота в градусах." },
        ],
      },
      {
        id: "scaled",
        name: "scaled",
        signature: "with scaled(sx, sy=None): ...",
        en: "Context-manager shorthand for push(); scale(sx, sy); ...; pop().",
        ru: "Сокращение-контекстный менеджер для push(); scale(sx, sy); ...; pop().",
        example: "with scaled(2):\n    rect(50, 50, 30, 30)  # drawn 60×60, undone after the block",
        params: [
          { name: "sx", type: "number", en: "Horizontal scale factor.", ru: "Коэффициент масштабирования по горизонтали." },
          { name: "sy", type: "number", optional: true, en: "Vertical scale factor. Defaults to sx.", ru: "Коэффициент масштабирования по вертикали. По умолчанию равен sx." },
        ],
      },
      {
        id: "camera",
      ...
      },
      {
        id: "stamp",
        name: "Stamp",
        signature: "with Stamp() as icon: ...",
        en: "Record a reusable drawing macro, then replay it anywhere with .draw(x, y, angle). Draw commands issued inside the `with` block are captured instead of rendered immediately. .draw() with no args uses the currently-active transform, so it composes for free with translated()/rotated()/push()/pop(). .draw(p, angle) accepts a point (tuple or Vector2) instead of x, y. .draw(actor) is sugar that reads actor.x/.y/.angle.",
        ru: "Записывает переиспользуемый макрос отрисовки и воспроизводит его где угодно через .draw(x, y, angle). Команды рисования внутри блока `with` записываются, а не рисуются сразу. .draw() без аргументов использует текущую активную трансформацию, поэтому бесплатно комбинируется с translated()/rotated()/push()/pop(). .draw(p, angle) принимает точку (кортеж или Vector2) вместо x, y. .draw(actor) — сахар, читающий actor.x/.y/.angle.",
        example: "icon = Stamp()\nwith icon:\n    fill(Colors.red)\n    circle(0, 0, 10)\n\ndef main():\n    icon.draw(100, 100)     # replay at (100, 100)\n    icon.draw((100, 100))   # same, via a point\n    icon.draw(player)       # sugar: reads player.x/.y/.angle\n    with translated(50, 0):\n        icon.draw()         # no args -> uses the active transform",
        params: [
          { name: "draw(x=0, y=0, angle=0)", type: "—", en: "Replay the recorded commands at (x, y) rotated by angle.", ru: "Воспроизводит записанные команды в позиции (x, y) с поворотом angle." },
          { name: "draw(p, angle=0)", type: "—", en: "Replay at point p (tuple or Vector2), rotated by angle.", ru: "Воспроизводит в точке p (кортеж или Vector2) с поворотом angle." },
          { name: "draw(actor)", type: "—", en: "Replay at the actor's current x/y/angle.", ru: "Воспроизводит в текущих x/y/angle актора." },
        ],
      },
    ],
  },
  ...
  // ─── Math ──────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "Build a Vector2 from a magnitude and an angle in degrees. Angle convention matches actor.angle and actor.forward(): 0° = north (up), 90° = east (+x), 180° = south, 270° = west — clockwise like a compass. The most common use is calling actor.set_vel(...) for continuous motion at an angle without writing the trig yourself.",
        ru: "Создаёт Vector2 из модуля и угла в градусах. Соглашение об угле совпадает с actor.angle и actor.forward(): 0° = север (вверх), 90° = восток (+x), 180° = юг, 270° = запад — по часовой стрелке, как компас. Чаще всего применяется для задания actor.set_vel(...) — непрерывное движение под углом без ручной тригонометрии.",
        example: "bullet.set_vel(Polar(8, ship.angle))  # move at speed 8 in ship's direction",
        advanced: {
        ...
        params: [
          ...
          { name: "Polar(120, 90)", type: "Vector2", en: "120 px/frame to the right (east). Pass to actor.set_vel(...) for movement.", ru: "120 px/кадр вправо (восток). Передайте в actor.set_vel(...) для движения." },
  ...
  // ─── Shapes ────────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "A closed region built from a ring of points — a lake, a platform, a level boundary. The last point joins back to the first, so you do not repeat it. Ask level.contains(point) to test if something is inside, and bounce off any edge with ball.set_vel(ball.vel().bounce_of(level, at=ball.pos())). draw() fills it with the current fill color and outlines it with the current stroke.",
        ru: "Замкнутая область из кольца точек — озеро, платформа, граница уровня. Последняя точка соединяется с первой, повторять её не нужно. level.contains(point) проверяет, внутри ли точка, а ball.set_vel(ball.vel().bounce_of(level, at=ball.pos())) отражает от ближайшего ребра. draw() заливает область текущим цветом заливки и обводит текущим цветом обводки.",
      ...
      },
      {
        ...
        returns: { type: "Vector2", en: "A new reflected velocity — pass it to actor.set_vel(...).", ru: "Новая отражённая скорость — передайте её в actor.set_vel(...)." },
        advanced: {
  ...
  // ─── Animation ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "Wall-clock countdown timer. Poll t.is_done() (or t.left() <= 0) each frame, then call t.restart() to start the next interval. Frame-rate independent. Example: t = Timer(s=2); if t.is_done(): spawn(); t.restart()",
        ru: "Таймер обратного отсчёта по реальному времени. Каждый кадр проверяйте t.is_done() (или t.left() <= 0), затем вызывайте t.restart() для следующего интервала. Не зависит от частоты кадров. Пример: t = Timer(s=2); if t.is_done(): spawn(); t.restart()",
        example: "t = Timer(s=2)\n\ndef main():\n    if t.is_done():\n        spawn_enemy()\n        t.restart()",
        advanced: {
          en: "Timer is wall-clock (`time.monotonic()`), so it ticks during stalls and across `frame_rate()` changes — use it whenever you want behaviour independent of fps. `is_done()` stays True until you call `restart()`, so without a restart the branch fires every frame after expiry. Constructing `Timer()` with no `s` or `ms` gives duration 0 — it's already done on frame 1; pair with `restart(s=…)` when you need a deferred first interval.",
          ru: "Timer работает по реальному времени (`time.monotonic()`), так что тикает и во время просадок, и при смене `frame_rate()` — используй его, если поведение должно быть независимым от fps. `is_done()` остаётся True, пока не вызовешь `restart()` — без рестарта ветка будет срабатывать каждый кадр после истечения. `Timer()` без `s`/`ms` имеет длительность 0 — уже готов на первом кадре; используй `restart(s=…)` для отложенного первого интервала.",
        },
        params: [
  ...
  // ─── Window & Anchors ──────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "AnchorPoint-returning methods at screen edges and corners. Pass the result to text() or say() for automatic edge-aligned placement with built-in padding. All positions update dynamically if the canvas is resized.",
        ru: "Методы, возвращающие AnchorPoint у краёв и углов экрана. Передайте результат в text() или say() для автоматического размещения у края с отступом. Все позиции обновляются динамически при изменении размера холста.",
      ...
      },
      {
        ...
        en: "Represents a position with alignment hints. Returned by Window.<edge>() and actor.<edge>() methods. Pass it to text() or say(). x and y can be callables (for dynamic positions) or plain numbers.",
        ru: "Представляет позицию с подсказками о выравнивании. Возвращается методами Window.<edge>() и actor.<edge>(). Передайте его в text() или say(). x и y могут быть функциями (для динамических позиций) или числами.",
    ...
    entries: [
      {
        ...
        params: [
          ...
          { name: "angle", type: "number", optional: true, default: "0", en: "Visual rotation in degrees, clockwise from north: 0° = up, 90° = right, 180° = down. Affects draw() and actor.forward(distance) (steps along this angle). For continuous motion at an angle, call actor.set_vel(Polar(speed, angle)) and call actor.move() each frame.", ru: "Визуальный угол поворота в градусах, по часовой стрелке от севера: 0° = вверх, 90° = вправо, 180° = вниз. Влияет на отрисовку и actor.forward(distance) (шаг вдоль этого угла). Для непрерывного движения под углом вызовите actor.set_vel(Polar(speed, angle)) и вызывайте actor.move() каждый кадр." },
      ...
      },
      {
        ...
        params: [
          ...
          { name: "pos()", type: "Vector2", en: "Position as a fresh Vector2 computed from x/y — parens required (it's a getter method, not a stored property). Mutating the returned vector does NOT move the actor. Set with set_pos(v). Useful for math: actor.set_pos(actor.pos() + Vector2(0, 1)).", ru: "Позиция как новый Vector2, вычисленный из x/y — скобки обязательны (это метод-геттер, а не хранимое свойство). Изменение возвращённого вектора НЕ двигает актёра. Устанавливается через set_pos(v). Удобно для математики: actor.set_pos(actor.pos() + Vector2(0, 1))." },
          { name: "set_pos(v)", type: "—", en: "Set position from a Vector2 or (x, y) pair.", ru: "Устанавливает позицию из Vector2 или пары (x, y)." },
          { name: "vel()", type: "Vector2", en: "Velocity as a fresh Vector2 computed from vx/vy — parens required (getter method). Mutating the returned vector does NOT change the actor. Set with set_vel(v). Build one with Polar(speed, angle) for movement at an angle: bullet.set_vel(Polar(8, ship.angle)).", ru: "Скорость как новый Vector2, вычисленный из vx/vy — скобки обязательны (метод-геттер). Изменение возвращённого вектора НЕ меняет актёра. Устанавливается через set_vel(v). Используйте Polar(speed, angle) для движения под углом: bullet.set_vel(Polar(8, ship.angle))." },
          { name: "set_vel(v)", type: "—", en: "Set velocity from a Vector2 or (x, y) pair.", ru: "Устанавливает скорость из Vector2 или пары (x, y)." },
          { name: "forward(distance)", type: "—", en: "One-shot step: move forward by distance in the direction of angle (0° = up, 90° = right). Useful when you want a per-frame imperative step instead of a continuous velocity. For continuous motion at an angle, call actor.set_vel(Polar(distance_per_frame, angle)) and call move() each frame.", ru: "Одношаговое движение: сместиться вперёд на distance в направлении угла (0° = вверх, 90° = вправо). Подходит, когда нужен императивный шаг каждый кадр, а не постоянная скорость. Для непрерывного движения под углом вызовите actor.set_vel(Polar(скорость_за_кадр, angle)) и вызывайте move() каждый кадр." },
          ...
          { name: "future_state", type: "ActorSnapshot", en: "One-frame lookahead. actor.future_state.collides_any(walls) returns the wall the actor will hit next frame, without moving the actor. Use to stop motion before a collision: if player.future_state.collides_any(walls): player.set_vel((0, 0)).", ru: "Снимок состояния через один кадр. actor.future_state.collides_any(walls) возвращает стену, в которую актор столкнётся в следующем кадре, не двигая его. Используйте, чтобы остановить движение до столкновения: if player.future_state.collides_any(walls): player.set_vel((0, 0))." },
        ],
      },
      {
        id: "actor_collider",
  ...
  // ─── Tilemap ───────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "cell_bounds",
        name: "Cell / Bounds",
        signature: "Cell(x, y) / Bounds(min, max, width, height)",
        en: "Small namedtuples returned by TileGroup. Cell(x, y) is one grid cell, yielded by group.cells() and group.random_cell(). Bounds(min, max, width, height) is returned by group.bounds() — min/max are Cell namedtuples for the group's corners.",
        ru: "Небольшие namedtuple, возвращаемые TileGroup. Cell(x, y) — одна ячейка сетки, отдаётся group.cells() и group.random_cell(). Bounds(min, max, width, height) возвращается group.bounds() — min/max это Cell для углов группы.",
        example: 'g = level.group("room")\nfor cell in g.cells():\n    print(cell.x, cell.y)\nb = g.bounds()\nprint(b.min.x, b.max.y, b.width, b.height)',
        params: [
          { name: "x, y", type: "int", en: "Grid column/row of a Cell.", ru: "Столбец/строка ячейки Cell." },
          { name: "min, max", type: "Cell", en: "Bounds corners as Cell namedtuples.", ru: "Углы Bounds в виде Cell." },
          { name: "width, height", type: "int", en: "Bounds size in cells.", ru: "Размер Bounds в ячейках." },
        ],
      },
      {
      ...
      },
      {
        ...
        example: 'hit = level.collides_with_any(hero, ["ground", "walls", "platform"])\nif hit:\n    # Blocked by something solid\n    hero.x = prev_x',
        params: [
          { name: "actor", type: "Actor", en: "The actor to check for collision.", ru: "Актер для проверки столкновения." },
  ...
  // ─── Utilities ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "state_class",
        name: "State",
        signature: "state = State(**kwargs)",
        en: "A mutable namespace for variables that need to survive across frames — the recommended alternative to bare module-level globals. Pass starting values as keyword arguments; read and write attributes freely afterward.",
        ru: "Изменяемое пространство имён для переменных, которые должны сохраняться между кадрами — рекомендуемая альтернатива обычным глобальным переменным модуля. Начальные значения передаются именованными аргументами; атрибуты можно свободно читать и менять.",
        example: "state = State(score=0, lives=3)\n\ndef main():\n    state.score += 1\n    if state.lives <= 0:\n        stop()",
        advanced: {
          en: "State exists so persistent game variables don't have to be declared `global` inside every function that touches them — `state.score += 1` works from any function without a `global` statement, unlike a bare module-level `score = 0`.",
          ru: "State существует, чтобы не объявлять `global` в каждой функции, изменяющей переменную, — `state.score += 1` работает из любой функции без `global`, в отличие от обычной переменной модуля `score = 0`.",
        },
        params: [
          { name: "**kwargs", type: "any", en: "Initial attribute names and values, e.g. State(score=0, lives=3).", ru: "Имена и начальные значения атрибутов, например State(score=0, lives=3)." },
        ],
      },
      {
        id: "clamp_fn",
        ...
        en: "Clamp a value between lo and hi (inclusive). Useful for keeping a position on-screen or a volume/opacity in range.",
        ru: "Ограничивает значение диапазоном [lo, hi] (включительно). Полезно, чтобы удержать позицию на экране или громкость/прозрачность в допустимых пределах.",
        example: "x = clamp(x, 0, width())   # keep x inside the canvas\nvol = clamp(vol, 0, 1)      # keep volume in [0, 1]",
        params: [
          { name: "value", type: "number", en: "The value to clamp.", ru: "Значение для ограничения." },
          { name: "lo", type: "number", en: "Lower bound.", ru: "Нижняя граница." },
          { name: "hi", type: "number", en: "Upper bound.", ru: "Верхняя граница." },
        ],
        returns: { type: "number", en: "value, or lo/hi if value was outside the range.", ru: "value, либо lo/hi, если value выходило за диапазон." },
      },
      {
        id: "randint_fn",
        name: "randint",
        signature: "randint(a, b)",
        en: "Random integer between a and b, inclusive on both ends. Use this when you need a whole number, like a dice roll or a grid index.",
        ru: "Случайное целое число между a и b, включая обе границы. Используй, когда нужно целое число — например, бросок кубика или индекс в сетке.",
        example: "x = randint(0, 300)\nface = randint(1, 6)  # dice roll",
        params: [
          { name: "a", type: "int", en: "Lower bound (inclusive).", ru: "Нижняя граница (включительно)." },
          { name: "b", type: "int", en: "Upper bound (inclusive).", ru: "Верхняя граница (включительно)." },
        ],
        returns: { type: "int", en: "A random integer in [a, b].", ru: "Случайное целое в [a, b]." },
      },
      {
        id: "pick_fn",
        name: "pick",
        signature: "pick(seq)",
        en: "Pick a random item from a list or tuple. Raises a friendly error if the sequence is empty.",
        ru: "Выбирает случайный элемент из списка или кортежа. Вызывает понятную ошибку, если последовательность пуста.",
        example: 'color = pick([Colors.red, Colors.blue, Colors.green])\ntile = pick(["grass", "sand", "stone"])',
        params: [
          { name: "seq", type: "list | tuple", en: "A non-empty sequence to choose from.", ru: "Непустая последовательность для выбора." },
        ],
        returns: { type: "any", en: "One randomly chosen item from seq.", ru: "Один случайно выбранный элемент из seq." },
      },
      {
        id: "noise",
        name: "noise",
  ...
  // ─── Sprite Animation ──────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      {
        id: "animation_play",
        name: "animation.play / pause / reset / is_playing",
        signature: "animation.play()  animation.pause()  animation.reset()  animation.is_playing()",
        en: "Control playback. play() resumes, pause() freezes on the current frame, reset() jumps back to frame 0 and resumes. is_playing() reports whether it's currently advancing.",
        ru: "Управление воспроизведением. play() возобновляет, pause() замораживает на текущем кадре, reset() переходит к кадру 0 и возобновляет. is_playing() сообщает, воспроизводится ли анимация сейчас.",
      ...
      {
        id: "animation_done",
        name: "animation.is_done",
        signature: "animation.is_done()",
        ...
        example: "if death_anim.is_done():\n    hero.die()",
        advanced: {
          en: "`is_done()` requires *all three*: `loop=False`, playback stopped, *and* the last frame reached. A looping animation always returns False. Calling `reset()` flips it back to False and starts playback again from the first frame.",
          ru: "`is_done()` требует *одновременно*: `loop=False`, остановленное воспроизведение *и* достижение последнего кадра. Зацикленная анимация всегда возвращает False. `reset()` возвращает его в False и запускает воспроизведение с первого кадра.",
        },
  ...
  // ─── Lighting ─────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        en: "Set the color tint of light cones. Available names: 'neutral' (pure white), 'warm' (candlelight orange), 'cool' (blue daylight), 'moonlight' (pale blue), 'candle' (deep amber). Reading it back returns the name you set.",
        ru: "Задаёт цветовой тон световых конусов. Доступные имена: 'neutral' (чистый белый), 'warm' (оранжевый свет свечи), 'cool' (синий дневной свет), 'moonlight' (бледно-голубой), 'candle' (глубокий янтарный). При чтении возвращает установленное имя.",
        example: "light.shade = 'warm'",
        returns: { type: "str", en: "The current shade name.", ru: "Текущее имя тона." },
        params: [
      ...
      },
      {
        id: "light_flicker",
        name: "light.flicker",
        signature: "light.flicker = enabled",
        en: "Enable a subtle deterministic intensity flicker [0.85–1.0] per light source, simulating a torch or candle. Uses frame_count and a per-Light seed so multiple lights flicker independently.",
        ru: "Включает тонкое детерминированное мерцание интенсивности [0.85–1.0] для источника, имитируя факел или свечу. Использует frame_count и отдельный seed для каждого Light, чтобы источники мерцали независимо.",
        example: "light.shade = 'candle'\nlight.flicker = True",
        returns: { type: "bool", en: "Whether flicker is enabled.", ru: "Включено ли мерцание." },
        params: [
      ...
      },
      {
        ...
        en: "Change the light source radius after construction.",
        ru: "Изменяет радиус источника света после создания.",
        example: "light.radius = 250",
        returns: { type: "number", en: "The current radius in pixels.", ru: "Текущий радиус в пикселях." },
        params: [
  ...
  // ─── Debug tools ────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        ...
        advanced: {
          en: "Calling `watch(value)` without a label uses `repr(value)` as both label and display (useful for a single scalar: `watch(hero.x)` shows `100.0`). Once set, a label stays pinned at its last value for the rest of the run, even on frames that don't call `watch()` for it again — only a new `watch()` call for that label, or starting a new run, changes it. The Watch strip appears the first time a program calls `watch()` and hides when the program stops.",
          ru: "Вызов `watch(значение)` без метки использует `repr(значение)` одновременно как метку и отображаемое значение (удобно для одиночного числа: `watch(hero.x)` показывает `100.0`). После установки метка остаётся закреплённой с последним значением до конца запуска, даже если на каком-то кадре `watch()` для неё не вызывался — изменить её может только новый вызов `watch()` с этой меткой или новый запуск программы. Полоса Watch появляется при первом вызове `watch()` и скрывается, когда программа останавливается.",
        },
        params: [
    ...
    entries: [
      {
        ...
        en: "Register a 1-D sequence for the debug scrubber. Two independent layers: fill (red/green/blue/yellow/cyan/gray) and stroke (stroke_red/... — a colored border). Each layer picks its own selector: an index, debug.between, or debug.singles. A bare variable (e.g. green=i) auto-labels its legend row from the variable's name; pass name=\"...\" on a selector (or wrap with debug.named) to override it or label a non-trivial expression.",
        ru: "Регистрирует одномерную последовательность для отладочной ленты. Два независимых слоя: заливка (red/green/blue/yellow/cyan/gray) и обводка (stroke_red/... — цветная рамка). Каждому цвету — свой селектор: индекс, debug.between или debug.singles. Голая переменная (например, green=i) автоматически подписывает строку легенды именем переменной; задай name=\"...\" на селекторе (или оберни debug.named), чтобы переопределить имя или подписать нетривиальное выражение.",
        example: "from pi3 import debug\n\ndef binary_search(arr, target):\n    lo, hi = 0, len(arr) - 1\n    while lo <= hi:\n        mid = (lo + hi) // 2\n        debug.array(arr,\n            red=debug.between(lo, hi, name=\"search window\"),\n            green=debug.named(mid, \"mid\"),\n            stroke_blue=debug.singles(lo, hi, name=\"lo, hi\"))\n        debug.show()\n        if arr[mid] == target:\n            return mid\n        elif arr[mid] < target:\n            lo = mid + 1\n        else:\n            hi = mid - 1\n    return -1",
        advanced: {
          en: "Same call site inside a loop reuses one slot — the scrubber shows the array evolving over time. Different call sites become separate stacked slots.\n\nCell layers are independent: a cell can carry both a fill (from red=/green=/...) and a stroke (from stroke_red=/...). When fill and stroke are the SAME color, the border is drawn a shade darker so it stays visible against the fill. Precedence within a layer is last-wins across overlapping selectors. Legend name precedence is: explicit name= or debug.named() first, then the source variable's name for a bare fill kwarg, then the color name as a last resort.\n\nstroke_width= is one global knob per call (default 2). Bare int / list values auto-label from their variable name when it's a simple variable; for a computed/indexed expression (e.g. green=arr[i]) or a bare stroke_ color, wrap it with debug.named(value, \"label\") to give it a legend row.",
          ru: "Один и тот же вызов внутри цикла переиспользует слот — лента показывает эволюцию массива. Разные места вызова создают отдельные слоты.\n\nСлои ячейки независимы: у ячейки могут быть и заливка (red=/green=/...), и обводка (stroke_red=/...). Если заливка и обводка одного цвета, рамка автоматически рисуется на тон темнее, чтобы её было видно. Внутри слоя побеждает последний селектор при наложении. Приоритет имени для легенды: сначала явные name= или debug.named(), затем имя переменной для голого fill-параметра, и только потом название цвета.\n\nstroke_width= — единая толщина рамки на весь вызов (по умолчанию 2). Голые числа и списки автоматически подписываются именем переменной, если это простая переменная; для вычисляемых/индексированных выражений (например, green=arr[i]) или голых stroke_-цветов оберни debug.named(value, \"метка\"), чтобы задать строку в легенде.",
        },
        params: [
          { name: "data", type: "list | tuple", en: "Sequence to display.", ru: "Последовательность для отображения." },
          { name: "red / green / blue / yellow / cyan / gray", type: "int | debug.between | debug.singles | list | debug.named", optional: true, en: "Fill this cell with this color.", ru: "Залить ячейку этим цветом." },
      ...
      },
      {
        ...
        en: "Register a 2-D grid (list of lists) for the debug scrubber. Highlights accept debug.cell(row, col), an int (row index), a (row, col) tuple, or (row0, col0, row1, col1) region tuple.",
        ru: "Регистрирует двумерную сетку (список списков) для отладочной ленты. Подсветки принимают debug.cell(row, col), int (строка), кортеж (row, col) или регион (row0, col0, row1, col1).",
      ...
      },
      {
        ...
        en: "Register a string for per-character highlighting. Same selector syntax as debug.array: an index, debug.between(lo, hi), or debug.singles(...).",
        ru: "Регистрирует строку для посимвольной подсветки. Селекторы те же, что у debug.array: индекс, debug.between(lo, hi) или debug.singles(...).",
        example: "debug.text(\"abcdefg\", red=debug.between(2, 4), green=0)\ndebug.show()",
        params: [
      ...
      },
      {
        id: "debug_stack",
        name: "debug.stack",
        signature: "debug.stack(data, red=..., stroke_blue=..., stroke_width=2)",
        en: "Register a stack (top = last element) for the debug scrubber. Same fill/stroke selector syntax as debug.array — an index, debug.between, debug.singles, or debug.named — but indices count from the bottom, so the top of the stack is always index len(data) - 1.",
        ru: "Регистрирует стек (вершина = последний элемент) для отладочной ленты. Те же селекторы заливки/обводки, что у debug.array — индекс, debug.between, debug.singles или debug.named — но индексы считаются от дна, поэтому вершина стека всегда имеет индекс len(data) - 1.",
        example: "from pi3 import debug\n\nstk = []\nfor x in (1, 2, 3):\n    stk.append(x)\n    debug.stack(stk, green=debug.named(len(stk) - 1, \"top\"))\n    debug.show()",
        advanced: {
          en: "Rendered bottom-to-top like a physical stack — the top is drawn last/uppermost. To highlight the top after push or pop, use len(data) - 1 (guard against an empty stack before indexing).",
          ru: "Отрисовывается снизу вверх, как настоящий стек — вершина рисуется последней/сверху. Чтобы подсветить вершину после push/pop, используй len(data) - 1 (проверяй на пустой стек перед индексацией).",
        },
        params: [
          { name: "data", type: "list", en: "Stack contents, top = last element.", ru: "Содержимое стека, вершина = последний элемент." },
          { name: "red / green / blue / yellow / cyan / gray", type: "int | debug.between | debug.singles | list | debug.named", optional: true, en: "Fill this cell with this color.", ru: "Залить ячейку этим цветом." },
          { name: "stroke_red / stroke_green / ...", type: "same as above", optional: true, en: "Draw a border of this color around the cell.", ru: "Нарисовать вокруг ячейки рамку этого цвета." },
          { name: "stroke_width", type: "int", optional: true, default: "2", en: "Border thickness in pixels for all strokes in this call.", ru: "Толщина рамки в пикселях для всех обводок этого вызова." },
        ],
      },
      {
        id: "debug_queue",
        name: "debug.queue",
        signature: "debug.queue(data, red=..., stroke_blue=..., stroke_width=2)",
        en: "Register a queue (head = first element) for the debug scrubber. Same fill/stroke selector syntax as debug.array — the head is always index 0, the tail is always index len(data) - 1.",
        ru: "Регистрирует очередь (голова = первый элемент) для отладочной ленты. Те же селекторы заливки/обводки, что у debug.array — голова всегда имеет индекс 0, хвост — индекс len(data) - 1.",
        example: "from pi3 import debug\n\nq = []\nfor x in (1, 2, 3):\n    q.append(x)\n    debug.queue(q, blue=debug.named(0, \"head\"))\n    debug.show()\nq.pop(0)\ndebug.queue(q)\ndebug.show()",
        advanced: {
          en: "Rendered head-first (index 0 on the left/first). Dequeuing with data.pop(0) is O(n) on a plain list — fine for teaching-sized queues shown in the scrubber, but mention collections.deque if a student asks about performance.",
          ru: "Отрисовывается от головы (индекс 0 слева/первым). Извлечение data.pop(0) на обычном списке — O(n), для учебных очередей в ленте это нормально, но если спросят о производительности — можно упомянуть collections.deque.",
        },
        params: [
          { name: "data", type: "list", en: "Queue contents, head = first element.", ru: "Содержимое очереди, голова = первый элемент." },
          { name: "red / green / blue / yellow / cyan / gray", type: "int | debug.between | debug.singles | list | debug.named", optional: true, en: "Fill this cell with this color.", ru: "Залить ячейку этим цветом." },
          { name: "stroke_red / stroke_green / ...", type: "same as above", optional: true, en: "Draw a border of this color around the cell.", ru: "Нарисовать вокруг ячейки рамку этого цвета." },
          { name: "stroke_width", type: "int", optional: true, default: "2", en: "Border thickness in pixels for all strokes in this call.", ru: "Толщина рамки в пикселях для всех обводок этого вызова." },
        ],
      },
      {
        id: "debug_members",
        name: "debug.members",
        signature: "debug.members(data, red=..., stroke_blue=..., stroke_width=2)",
        en: "Register a set for the debug scrubber. Order doesn't matter for the data itself, but the scrubber has to draw items in some order — it renders them sorted, and highlight selectors index into that sorted order, not insertion order.",
        ru: "Регистрирует множество для отладочной ленты. Порядок элементов сам по себе не важен, но ленте нужно как-то их отрисовать — она сортирует их, и селекторы подсветки индексируют именно отсортированный порядок, а не порядок добавления.",
        example: "from pi3 import debug\n\nseen = {3, 1, 4, 1, 5}\ndebug.members(seen, green=0)  # highlights the smallest element (sorted order)\ndebug.show()",
        advanced: {
          en: "Because rendering requires sorted(data), every element must be mutually comparable — a set mixing ints and strings raises a TypeError here even though the set itself is valid Python. If a student's set holds unsortable/mixed items, convert to a sorted list of a display key before calling debug.members.",
          ru: "Так как отрисовка требует sorted(data), все элементы должны быть взаимно сравнимы — множество, смешивающее int и str, вызовет TypeError здесь, даже если само множество — валидный Python. Если множество ученика содержит несравнимые/смешанные элементы, преобразуй его в отсортированный список по ключу отображения перед debug.members.",
        },
        params: [
          { name: "data", type: "set", en: "Set contents; rendered in sorted order.", ru: "Содержимое множества; отрисовывается в отсортированном порядке." },
          { name: "red / green / blue / yellow / cyan / gray", type: "int | debug.between | debug.singles | list | debug.named", optional: true, en: "Fill this cell (by position in sorted order) with this color.", ru: "Залить ячейку (по позиции в отсортированном порядке) этим цветом." },
          { name: "stroke_red / stroke_green / ...", type: "same as above", optional: true, en: "Draw a border of this color around the cell.", ru: "Нарисовать вокруг ячейки рамку этого цвета." },
          { name: "stroke_width", type: "int", optional: true, default: "2", en: "Border thickness in pixels for all strokes in this call.", ru: "Толщина рамки в пикселях для всех обводок этого вызова." },
        ],
      },
      ...
      },
      {
        id: "debug_between",
        name: "debug.between",
        signature: "debug.between(lo, hi, *, name=None)",
        ...
        example: "debug.array(arr, red=debug.between(lo, hi, name=\"search window\"))",
        params: [
      ...
      },
      {
        ...
        en: "1-D selector that marks each argument as its own single-cell highlight. Use to show endpoint markers alongside a debug.between fill.",
        ru: "Одномерный селектор: помечает каждый аргумент как одиночную ячейку. Удобно для маркеров границ рядом с заливкой debug.between.",
      ...
      },
      {
        ...
        example: "debug.array(arr,\n    red=debug.between(lo, hi, name=\"window\"),\n    green=debug.named(mid, \"mid\"))",
        advanced: {
