  ...
  // ─── Transforms ────────────────────────────────────────────────────────────
  {
    ...
    entries: [
      ...
      },
      {
        id: "translated",
        name: "translated",
        signature: "with translated(dx, dy): ...",
        en: "Context-manager shorthand for push(); translate(dx, dy); ...; pop() — the block is automatically wrapped, so you can't forget the matching pop(). Composes with rotated(), scaled(), and plain push()/translate()/rotate().",
        ru: "Сокращение-контекстный менеджер для push(); translate(dx, dy); ...; pop() — блок оборачивается автоматически, забыть парный pop() невозможно. Комбинируется с rotated(), scaled() и обычными push()/translate()/rotate().",
        example: "with translated(100, 50):\n    circle(0, 0, 10)   # drawn at (100, 50)\ncircle(0, 0, 10)       # back at (0, 0)",
        params: [
          { name: "dx", type: "number", en: "Horizontal offset.", ru: "Смещение по горизонтали." },
          { name: "dy", type: "number", en: "Vertical offset.", ru: "Смещение по вертикали." },
        ],
      },
      {
        id: "rotated",
