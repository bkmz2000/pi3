...
import GraphicsInit from "../assets/python/pi3/__init__.py?raw";
import GraphicsActors from "../assets/python/pi3/actors/__init__.py?raw";
import GraphicsAnimation from "../assets/python/pi3/animation.py?raw";
